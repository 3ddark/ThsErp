...
type
  ...
  public
    ...
    procedure Delete(AModel: TSatSiparis; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TSatSiparisRepository.Delete(AModel: TSatSiparis; ACascade: TCascadeOperations);
begin
