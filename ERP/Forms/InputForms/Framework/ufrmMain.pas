...
/// </example>
    ...
    procedure actsys_guınExecute(Sender: TObject);
...
procedure TfrmMain.actsys_guınExecute(Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      raise Exception.Create(GSysUygulamaAyariDiger.PathUpdate.Value + AddLBs(2) + 'Güncelleme klasöründe dosyalar bulunamadı');
  end
  else
