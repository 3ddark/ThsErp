...
type
  TfrmAccOdemeBaslangicDonemi = class(TfrmBaseInputDB)
...
procedure TfrmAccOdemeBaslangicDonemi.RefreshData();
begin
...
procedure TfrmAccOdemeBaslangicDonemi.btnAcceptClick(Sender: TObject);
begin
