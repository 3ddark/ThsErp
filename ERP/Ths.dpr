...
uses
  ...
  PrsDriverLicence in 'BackEnd\Person\Domain\PrsDriverLicence.pas',
  PrsDriverLicence.Repository in 'BackEnd\Person\Repository\PrsDriverLicence.Repository.pas',
  PrsDriverLicence.Service in 'BackEnd\Person\Service\PrsDriverLicence.Service.pas',
  PrsLanguageAbility in 'BackEnd\Person\Domain\PrsLanguageAbility.pas',
  PrsLanguageAbility.Repository in 'BackEnd\Person\Repository\PrsLanguageAbility.Repository.pas',
  PrsLanguageAbility.Service in 'BackEnd\Person\Service\PrsLanguageAbility.Service.pas',
  PrsPerson in 'BackEnd\Person\Domain\PrsPerson.pas',
  PrsPerson.Repository in 'BackEnd\Person\Repository\PrsPerson.Repository.pas',
  PrsPerson.Service in 'BackEnd\Person\Service\PrsPerson.Service.pas',
  SetPrsUnit in 'BackEnd\Person\Domain\SetPrsUnit.pas',
  SetPrsUnit.Repository in 'BackEnd\Person\Repository\SetPrsUnit.Repository.pas',
  SetPrsUnit.Service in 'BackEnd\Person\Service\SetPrsUnit.Service.pas',
  SetPrsSection in 'BackEnd\Person\Domain\SetPrsSection.pas',
  SetPrsSection.Repository in 'BackEnd\Person\Repository\SetPrsSection.Repository.pas',
  SetPrsSection.Service in 'BackEnd\Person\Service\SetPrsSection.Service.pas',
  SetPrsDriverLicenceType in 'BackEnd\Person\Domain\SetPrsDriverLicenceType.pas',
  SetPrsDriverLicenceType.Repository in 'BackEnd\Person\Repository\SetPrsDriverLicenceType.Repository.pas',
  SetPrsDriverLicenceType.Service in 'BackEnd\Person\Service\SetPrsDriverLicenceType.Service.pas',
  SetPrsTask in 'BackEnd\Person\Domain\SetPrsTask.pas',
  SetPrsTask.Repository in 'BackEnd\Person\Repository\SetPrsTask.Repository.pas',
  SetPrsTask.Service in 'BackEnd\Person\Service\SetPrsTask.Service.pas',
  SetPrsLanguage in 'BackEnd\Person\Domain\SetPrsLanguage.pas',
  SetPrsLanguage.Repository in 'BackEnd\Person\Repository\SetPrsLanguage.Repository.pas',
  SetPrsLanguage.Service in 'BackEnd\Person\Service\SetPrsLanguage.Service.pas',
  SetPrsLanguageLevel in 'BackEnd\Person\Domain\SetPrsLanguageLevel.pas',
  SetPrsLanguageLevel.Repository in 'BackEnd\Person\Repository\SetPrsLanguageLevel.Repository.pas',
  SetPrsLanguageLevel.Service in 'BackEnd\Person\Service\SetPrsLanguageLevel.Service.pas',
  SetPrsPersonType in 'BackEnd\Person\Domain\SetPrsPersonType.pas',
  SetPrsPersonType.Repository in 'BackEnd\Person\Repository\SetPrsPersonType.Repository.pas',
  SetPrsPersonType.Service in 'BackEnd\Person\Service\SetPrsPersonType.Service.pas',
  SetPrsTransportation in 'BackEnd\Person\Domain\SetPrsTransportation.pas',
  SetPrsTransportation.Repository in 'BackEnd\Person\Repository\SetPrsTransportation.Repository.pas',
  SetPrsTransportation.Service in 'BackEnd\Person\Service\SetPrsTransportation.Service.pas';
