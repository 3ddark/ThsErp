...
begin
  ...
  if (pFormMode = ifmRewiev) then
    Result := TEmpDriverLicenceForm.Create(Application, Self, Table.Clone(), pFormMode)
  else if (pFormMode = ifmNewRecord) then
    Result := TEmpDriverLicenceForm.Create(Application, Self, TEmpDriverLicence.Create(Table.Database), pFormMode)
