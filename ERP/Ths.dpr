...
uses
  ...
  ufrmSetPrsLisanBilgileri in 'Forms\OutputForms\DbGrid\Core\Prs\ufrmSetPrsLisanBilgileri.pas' {frmSetPrsLisanBilgileri},
  ufrmSetPrsLisanBilgisi in 'Forms\InputForms\Core\Prs\ufrmSetPrsLisanBilgisi.pas' {frmSetPrsLisanBilgisi},
  Ths.Database.Table.PrsPersonelEhliyetleri in 'BackEnd\Core\Prs\Ths.Database.Table.PrsPersonelEhliyetleri.pas',
  ufrmPrsPersonelEhliyetleri in 'Forms\OutputForms\DbGrid\Core\Prs\ufrmPrsPersonelEhliyetleri.pas' {frmPrsPersonelEhliyetleri},
  ufrmPrsPersonelEhliyet in 'Forms\InputForms\Core\Prs\ufrmPrsPersonelEhliyet.pas' {frmPrsPersonelEhliyet},
