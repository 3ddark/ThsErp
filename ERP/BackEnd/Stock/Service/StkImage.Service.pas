...
uses
  ...
  StkImage.Repository, StkImage;

type
  TStkImageService = class(TCrudService<TStkImage>)
  private
    FRepo: IRepository<TStkImage>;
  public
    constructor Create;
    ...
    procedure Add(AEntity: TStkImage); override;
    procedure Update(AEntity: TStkImage); override;
...
constructor TStkImageService.Create;
begin
  inherited;
  FRepo := Self.UoW.GetRepository<TStkImage, TStkImageRepository>;
end;

destructor TStkImageService.Destroy;
begin
  inherited;
end;
...
procedure TStkImageService.Add(AEntity: TStkImage);
begin
  FRepo.Add(AEntity);
end;

procedure TStkImageService.Update(AEntity: TStkImage);
begin
  FRepo.Update(AEntity);
end;

procedure TStkImageService.Delete(AId: Int64);
begin
  FRepo.Delete(AId);
end;
