...
begin
  ...
  FReceteAdi := TFieldDB.Create('recete_adi', ftWideString, '', Self, 'Reçete Adı');
  FOrnekUretimMiktari := TFieldDB.Create('ornek_uretim_miktari', ftFloat, 0, Self, 'Örnek Üretim Miktarı');
