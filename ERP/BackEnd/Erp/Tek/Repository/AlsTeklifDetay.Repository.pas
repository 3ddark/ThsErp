...
type
  ...
  public
    ...
    procedure Delete(AModel: TAlsTeklifDetay; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TAlsTeklifDetayRepository.Delete(AModel: TAlsTeklifDetay; ACascade: TCascadeOperations);
begin
