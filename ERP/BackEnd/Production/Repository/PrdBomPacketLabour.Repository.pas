...
type
  ...
  public
    ...
    procedure Delete(AModel: TPrdBomPacketLabour; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TPrdBomPacketLabourRepository.Delete(AModel: TPrdBomPacketLabour; ACascade: TCascadeOperations);
begin
