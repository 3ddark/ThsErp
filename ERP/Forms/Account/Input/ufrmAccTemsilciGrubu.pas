...
type
  TfrmAccTemsilciGrubu = class(TfrmBaseInputDB)
...
procedure TfrmAccTemsilciGrubu.btnAcceptClick(Sender: TObject);
begin
...
procedure TfrmAccTemsilciGrubu.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAccTemsilciGrubu.FormDestroy(Sender: TObject);
begin
