...
type
  TfrmAccDovizKuru = class(TfrmBaseInputDB)
    lbltarih: TLabel;
    edttarih: TEdit;
...
procedure TfrmAccDovizKuru.btnAcceptClick(Sender: TObject);
begin
...
procedure TfrmAccDovizKuru.FormShow(Sender: TObject);
begin
...
procedure TfrmAccDovizKuru.HelperProcess(Sender: TObject);
var
...
procedure TfrmAccDovizKuru.RefreshData;
begin
