...
function TfrmAyarEFaturaIstisnaKodlari.CreateInputForm(Sender: TObject; pFormMode: TInputFormMode): TForm;
begin
  Result := nil;
  if (pFormMode = ifmRewiev) then
    Result := TfrmAyarEFaturaIstisnaKodu.Create(Self, Self, Table.Clone(), pFormMode)
  else if (pFormMode = ifmNewRecord) then
    Result := TfrmAyarEFaturaIstisnaKodu.Create(Self, Self, TAyarEFaturaIstisnaKodu.Create(Table.Database), pFormMode)
