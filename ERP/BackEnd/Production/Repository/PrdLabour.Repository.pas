...
type
  ...
  public
    ...
    procedure Delete(AModel: TPrdLabour; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TPrdLabourRepository.Delete(AModel: TPrdLabour; ACascade: TCascadeOperations);
begin
