...
type
  TfrmAccHesapTipi = class(TfrmBaseInputDB)
    edthesap_tipi: TEdit;
...
procedure TfrmAccHesapTipi.RefreshData();
begin
  edthesap_tipi.Text := TSetChHesapTipi(Table).HesapTipi.AsString;
end;

procedure TfrmAccHesapTipi.btnAcceptClick(Sender: TObject);
begin
