...
type
  TfrmAccBolgeTuru = class(TfrmBaseInputDB)
    edtbolge_turu: TEdit;
...
procedure TfrmAccBolgeTuru.RefreshData();
begin
...
procedure TfrmAccBolgeTuru.btnAcceptClick(Sender: TObject);
begin
