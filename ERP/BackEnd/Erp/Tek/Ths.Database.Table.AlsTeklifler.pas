...
begin
  ...
  FMusteriTemsilcisi := TFieldDB.Create('musteri_temsilcisi', ftString, '', Self);
  ...
  FTevkifatKodu := TFieldDB.Create('tevkifat_kodu', ftWideString, '', Self);
  FTevkifatAciklama := TFieldDB.Create('tevkifat_aciklama', ftWideString, '', Self);
  FTevkifatPay := TFieldDB.Create('tevkifat_pay', ftSmallint, 0, Self);
  FTevkifatPayda := TFieldDB.Create('tevkifat_payda', ftSmallint, 0, Self);
