...
type
  ...
  public
    ...
    procedure Delete(AModel: TSatSiparisDetay; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TSatSiparisDetayRepository.Delete(AModel: TSatSiparisDetay; ACascade: TCascadeOperations);
begin
