...
type
  TfrmAccFasonMarka = class(TfrmBaseInputDB)
...
procedure TfrmAccFasonMarka.RefreshData();
begin
  edtfason_marka.Text := VarToStr( FormatedVariantVal(TSetChFasonMarka(Table).FasonMarka) );
end;

procedure TfrmAccFasonMarka.btnAcceptClick(Sender: TObject);
begin
