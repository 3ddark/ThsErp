...
uses
  ...
  StkCardSummary.Repository, StkCardSummary;

type
  TStkCardSummaryService = class(TCrudService<TStkCardSummary>)
  private
    FRepo: IRepository<TStkCardSummary>;
  public
    constructor Create;
    ...
    procedure Add(AEntity: TStkCardSummary); override;
    procedure Update(AEntity: TStkCardSummary); override;
...
constructor TStkCardSummaryService.Create;
begin
  inherited;
  FRepo := Self.UoW.GetRepository<TStkCardSummary, TStkCardSummaryRepository>;
end;

destructor TStkCardSummaryService.Destroy;
begin
  inherited;
end;
...
procedure TStkCardSummaryService.Add(AEntity: TStkCardSummary);
begin
  FRepo.Add(AEntity);
end;

procedure TStkCardSummaryService.Update(AEntity: TStkCardSummary);
begin
  FRepo.Update(AEntity);
end;

procedure TStkCardSummaryService.Delete(AId: Int64);
begin
  FRepo.Delete(AId);
end;
