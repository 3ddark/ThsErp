...
type
  ...
  public
    ...
    procedure Delete(AModel: TPrdPacketRaw; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TPrdPacketRawRepository.Delete(AModel: TPrdPacketRaw; ACascade: TCascadeOperations);
begin
