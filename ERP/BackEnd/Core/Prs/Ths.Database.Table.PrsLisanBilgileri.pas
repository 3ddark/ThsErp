...
begin
  ...
  FKonusmaID := TFieldDB.Create('konusma_id', ftInteger, 0, Self, 'Konuşma Seviyesi ID');
  FKonusma := TFieldDB.Create('konusma', FSetPrsLisanSeviyesi.LisanSeviyesi.DataType, '', Self, 'Konuşma Seviyesi', FSetPrsLisanSeviyesi.LisanSeviyesi.FieldName + '_speak', 0, True);
