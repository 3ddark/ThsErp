...
type
  ...
  public
    ...
    procedure Delete(AModel: TSysGuiContent; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TSysGuiContentRepository.Delete(AModel: TSysGuiContent; ACascade: TCascadeOperations);
begin
