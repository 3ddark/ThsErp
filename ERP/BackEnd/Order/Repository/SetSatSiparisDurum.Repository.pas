...
type
  ...
  public
    ...
    procedure Delete(AModel: TSetSatSiparisDurum; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TSetSatSiparisDurumRepository.Delete(AModel: TSetSatSiparisDurum; ACascade: TCascadeOperations);
begin
