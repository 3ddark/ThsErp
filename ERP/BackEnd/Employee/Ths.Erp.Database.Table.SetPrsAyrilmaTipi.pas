unit Ths.Erp.Database.Table.SetPrsAyrilmaTipi;
...
begin
  TableName := 'set_prs_ayrilma_tipi';
  TableSourceCode := MODULE_PRS_AYAR;
  inherited Create(ADatabase);

  FAyrilmaTipi := TFieldDB.Create('ayrilma_tipi', ftString, '', Self, 'Ayrýlma Tipi');
end;
  ...
  begin
    ...
    begin
      ...
      Database.GetSQLSelectCmd(QueryOfDS, TableName, [
        ...
        TableName + '.' + FAyrilmaTipi.FieldName
      ], [
        ' WHERE 1=1 ', AFilter
      ], AAllColumn, AHelper);
      Open;
...
procedure TSetPrsAyrilmaTipi.Insert(out AID: Integer; APermissionControl: Boolean);
begin
...
procedure TSetPrsAyrilmaTipi.Update(APermissionControl: Boolean);
begin
