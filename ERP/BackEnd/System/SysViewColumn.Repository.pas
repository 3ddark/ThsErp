...
uses
  ...
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, FireDAC.Stan.Param, System.Rtti,
...
type
  ...
  public
    ...
    procedure Add(AModel: TSysViewColumn); override;
    procedure AddBatch(AModels: TArray<TSysViewColumn>); override;
    procedure Update(AModel: TSysViewColumn); override;
    procedure UpdateBatch(AModels: TArray<TSysViewColumn>); override;
    procedure Delete(AId: Int64); override;
    procedure Delete(AFilter: TValue); override;
    procedure DeleteBatch(AModels: TArray<TSysViewColumn>); override;
  end;
...
procedure TSysViewColumnRepository.Add(AModel: TSysViewColumn);
begin
  raise Exception.Create('View not supported this process');
end;

procedure TSysViewColumnRepository.AddBatch(AModels: TArray<TSysViewColumn>);
begin
  raise Exception.Create('View not supported this process');
end;

procedure TSysViewColumnRepository.Delete(AFilter: TValue);
begin
  raise Exception.Create('View not supported this process');
end;
...
procedure TSysViewColumnRepository.DeleteBatch(AModels: TArray<TSysViewColumn>);
begin
  raise Exception.Create('View not supported this process');
end;

procedure TSysViewColumnRepository.Update(AModel: TSysViewColumn);
begin
  raise Exception.Create('View not supported this process');
end;

procedure TSysViewColumnRepository.UpdateBatch(AModels: TArray<TSysViewColumn>);
begin
  raise Exception.Create('View not supported this process');
end;
