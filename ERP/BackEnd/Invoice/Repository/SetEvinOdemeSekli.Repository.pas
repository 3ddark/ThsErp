...
type
  ...
  public
    ...
    procedure Delete(AModel: TSetEvinPaymentMethod; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TSetEvinPaymentMethodRepository.Delete(AModel: TSetEvinPaymentMethod; ACascade: TCascadeOperations);
begin
