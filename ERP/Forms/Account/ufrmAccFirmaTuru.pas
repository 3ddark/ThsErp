...
type
  TfrmAccFirmaTuru = class(TfrmBaseInputDB)
    edtfirma_turu: TEdit;
...
procedure TfrmAccFirmaTuru.RefreshData();
begin
  edtfirma_turu.Text := TSetChFirmaTuru(Table).FirmaTuru.Value;
end;

procedure TfrmAccFirmaTuru.btnAcceptClick(Sender: TObject);
begin
