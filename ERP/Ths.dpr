...
uses
  ...
  StkKindFamily in 'BackEnd\Core\Base\StkKindFamily.pas',
  StkKindFamilyRepository in 'BackEnd\Core\Base\StkKindFamilyRepository.pas',
  StkKindFamilyService in 'BackEnd\Core\Base\StkKindFamilyService.pas',
  SysCountry in 'BackEnd\System\SysCountry.pas',
  SysCountry.Repository in 'BackEnd\System\SysCountry.Repository.pas',
  SysCountry.Service in 'BackEnd\System\SysCountry.Service.pas',
  SysRegion in 'BackEnd\System\SysRegion.pas',
  SysRegion.Repository in 'BackEnd\System\SysRegion.Repository.pas',
  SysRegion.Service in 'BackEnd\System\SysRegion.Service.pas',
  SysViewColumn in 'BackEnd\System\SysViewColumn.pas',
  SysViewColumn.Repository in 'BackEnd\System\SysViewColumn.Repository.pas',
  SysViewColumn.Service in 'BackEnd\System\SysViewColumn.Service.pas',
  SysCity in 'BackEnd\System\SysCity.pas',
  SysCity.Repository in 'BackEnd\System\SysCity.Repository.pas',
  SysCity.Service in 'BackEnd\System\SysCity.Service.pas',
  ufrmGrid in 'Forms\Core\ufrmGrid.pas',
  ufrmInputSimpleDbX in 'Forms\Core\ufrmInputSimpleDbX.pas',
  ufrmStkKindFamilies in 'Forms\Stock\ufrmStkKindFamilies.pas' {frmStkKindFamilies},
  ufrmStkKindFamily in 'Forms\Stock\ufrmStkKindFamily.pas' {frmStkKindFamily},
