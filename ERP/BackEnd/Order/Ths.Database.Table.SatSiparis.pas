...
begin
  ...
  FTeklifID := TFieldDB.Create('teklif_id', ftInteger, 0, Self);
  ...
  FSiparisTarihi := TFieldDB.Create('siparis_tarihi', ftDateTime, 0, Self);
  FTeslimTarihi := TFieldDB.Create('teslim_tarihi', ftDateTime, 0, Self);
  ...
  FUlke := TFieldDB.Create(FSysCountry.UlkeAdi.FieldName, FSysCountry.UlkeAdi.DataType, '', Self);
  FSehirID := TFieldDB.Create('sehir_id', ftInteger, 0, Self);
  FSehir := TFieldDB.Create(FSysCity.Sehir.FieldName, FSysCity.Sehir.DataType, '', Self);
  ...
  FMuhattapAd := TFieldDB.Create('muhattap_ad', ftString, '', Self);
  FReferans := TFieldDB.Create('referans', ftString, '', Self);
  ...
  FSiparisDurumID := TFieldDB.Create('siparis_durum_id', ftInteger, 0, Self);
  FSiparisDurum := TFieldDB.Create(FSetSiparisDurum.SiparisDurum.FieldName, FSetSiparisDurum.SiparisDurum.DataType, '', Self);
