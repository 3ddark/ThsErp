...
type
  TfrmAccTemsilciGrupTuru = class(TfrmBaseInputDB)
...
procedure TfrmAccTemsilciGrupTuru.RefreshData();
begin
...
procedure TfrmAccTemsilciGrupTuru.btnAcceptClick(Sender: TObject);
begin
