...
uses
  ...
  ufrmLogin in 'Forms\Core\ufrmLogin.pas' {frmLogin},
  ufrmDashboard in 'Forms\Core\ufrmDashboard.pas' {frmDashboard},
  ...
  ufrmSysAccessRight in 'Forms\System\ufrmSysAccessRight.pas' {frmSysAccessRight},
  ufrmSysAccessRights in 'Forms\System\ufrmSysAccessRights.pas' {frmSysAccessRights},
  ...
  ufrmSysAddress in 'Forms\System\ufrmSysAddress.pas' {frmSysAddress},
  ufrmSysAddresses in 'Forms\System\ufrmSysAddresses.pas' {frmSysAddresses},
  ...
  ufrmSysCurrency in 'Forms\System\ufrmSysCurrency.pas' {frmSysCurrency},
  ufrmSysCurrencies in 'Forms\System\ufrmSysCurrencies.pas' {frmSysCurrencies},
  ...
  ufrmSysDay in 'Forms\System\ufrmSysDay.pas' {frmSysDay},
  ufrmSysDays in 'Forms\System\ufrmSysDays.pas' {frmSysDays},
  ...
  ufrmSysDecimalPlace in 'Forms\System\ufrmSysDecimalPlace.pas' {frmSysDecimalPlace},
  ufrmSysDecimalPlaces in 'Forms\System\ufrmSysDecimalPlaces.pas' {frmSysDecimalPlaces},
  ...
  ufrmSysGridColumn in 'Forms\System\ufrmSysGridColumn.pas' {frmSysGridColumn},
  ufrmSysGridColumns in 'Forms\System\ufrmSysGridColumns.pas' {frmSysGridColumns},
  ...
  ufrmSysGridColumnTitle in 'Forms\System\ufrmSysGridColumnTitle.pas' {frmSysGridColumnTitle},
  ufrmSysGridColumnTitles in 'Forms\System\ufrmSysGridColumnTitles.pas' {frmSysGridColumnTitles},
  ...
  ufrmSysGridFilter in 'Forms\System\ufrmSysGridFilter.pas' {frmSysGridFilter},
  ufrmSysGridFilters in 'Forms\System\ufrmSysGridFilters.pas' {frmSysGridFilters},
  ...
  ufrmSysGridSort in 'Forms\System\ufrmSysGridSort.pas' {frmSysGridSort},
  ufrmSysGridSorts in 'Forms\System\ufrmSysGridSorts.pas' {frmSysGridSorts},
  ...
  ufrmSysGuiContent in 'Forms\System\ufrmSysGuiContent.pas' {frmSysGuiContent},
  ufrmSysGuiContents in 'Forms\System\ufrmSysGuiContents.pas' {frmSysGuiContents},
  ...
  ufrmSysLanguage in 'Forms\System\ufrmSysLanguage.pas' {frmSysLanguage},
  ufrmSysLanguages in 'Forms\System\ufrmSysLanguages.pas' {frmSysLanguages},
  ...
  ufrmSysMonth in 'Forms\System\ufrmSysMonth.pas' {frmSysMonth},
  ufrmSysMonths in 'Forms\System\ufrmSysMonths.pas' {frmSysMonths},
  ...
  ufrmSysPermission in 'Forms\System\ufrmSysPermission.pas' {frmSysPermission},
  ufrmSysPermissions in 'Forms\System\ufrmSysPermissions.pas' {frmSysPermissions},
  ...
  ufrmSysPermissionGroup in 'Forms\System\ufrmSysPermissionGroup.pas' {frmSysPermissionGroup},
  ufrmSysPermissionGroups in 'Forms\System\ufrmSysPermissionGroups.pas' {frmSysPermissionGroups},
  ...
  ufrmSysUser in 'Forms\System\ufrmSysUser.pas' {frmSysUser},
  ufrmSysUsers in 'Forms\System\ufrmSysUsers.pas' {frmSysUsers},
  ...
  ufrmSysViewTables in 'Forms\System\ufrmSysViewTables.pas' {frmSysViewTables},
