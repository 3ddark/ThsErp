unit ufrmAccTemsilciGrubuHedef;
...
type
  TfrmAccTemsilciGrubuHedef = class(TfrmBaseInputDB)
...
procedure TfrmAccTemsilciGrubuHedef.btnAcceptClick(Sender: TObject);
begin
...
procedure TfrmAccTemsilciGrubuHedef.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAccTemsilciGrubuHedef.FormDestroy(Sender: TObject);
begin
  FTemsilciGrup.Free;
  FPara.Free;
  inherited;
...
procedure TfrmAccTemsilciGrubuHedef.FormShow(Sender: TObject);
begin
  inherited;
  {$IFDEF DUMMY_VALUE}
