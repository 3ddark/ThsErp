...
begin
  ...
  begin
    ...
    begin
      ...
      setFieldTitle(FTemsilciGrupAdi, 'Temsilci Grup Adý';
      setFieldTitle(FGecmisOcak, 'Geçmiþ Ocak';
      setFieldTitle(FGecmisSubat, 'Geçmiþ Þubat';
      setFieldTitle(FGecmisMart, 'Geçmiþ Mart';
      setFieldTitle(FGecmisNisan, 'Geçmiþ Nisan';
      setFieldTitle(FGecmisMayis, 'Geçmiþ Mayýs';
      setFieldTitle(FGecmisHaziran, 'Geçmiþ Haziran';
      setFieldTitle(FGecmisTemmuz, 'Geçmiþ Temmuz';
      setFieldTitle(FGecmisAgustos, 'Geçmiþ Aðustos';
      setFieldTitle(FGecmisEylul, 'Geçmiþ Eylül';
      setFieldTitle(FGecmisEkim, 'Geçmiþ Ekim';
      setFieldTitle(FGecmisKasim, 'Geçmiþ Kasým';
      setFieldTitle(FGecmisAralik, 'Geçmiþ Aralýk';
      setFieldTitle(FHedefOcak, 'Hedef Ocak';
      setFieldTitle(FHedefSubat, 'Hedef Þubat';
      setFieldTitle(FHedefMart, 'Hedef Mart';
      setFieldTitle(FHedefNisan, 'Hedef Nisan';
      setFieldTitle(FHedefMayis, 'Hedef Mayýs';
      setFieldTitle(FHedefHaziran, 'Hedef Haziran';
      setFieldTitle(FHedefTemmuz, 'Hedef Temmuz';
      setFieldTitle(FHedefAgustos, 'Hedef Aðustos';
      setFieldTitle(FHedefEylul, 'Hedef Eylül';
      setFieldTitle(FHedefEkim, 'Hedef Ekim';
      setFieldTitle(FHedefKasim, 'Hedef Kasým';
      setFieldTitle(FHedefAralik, 'Hedef Aralýk';
    end;
  end;
end;
