...
type
  ...
  public
    ...
    procedure Delete(AModel: TPrdBomRaw; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TPrdBomRawRepository.Delete(AModel: TPrdBomRaw; ACascade: TCascadeOperations);
begin
