...
begin
  ...
  if (pFormMode = ifmRewiev) then
    Result := TfrmSetPrsServisAraci.Create(Application, Self, Table.Clone(), pFormMode)
  else if (pFormMode = ifmNewRecord) then
    Result := TfrmSetPrsServisAraci.Create(Application, Self, TSetPrsServisAraci.Create(Table.Database), pFormMode)
