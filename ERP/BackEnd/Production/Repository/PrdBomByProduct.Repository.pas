...
type
  ...
  public
    ...
    procedure Delete(AModel: TPrdBomByProduct; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TPrdBomByProductRepository.Delete(AModel: TPrdBomByProduct; ACascade: TCascadeOperations);
begin
