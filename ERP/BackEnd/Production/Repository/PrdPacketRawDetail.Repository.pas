...
type
  ...
  public
    ...
    procedure Delete(AModel: TPrdPacketRawDetail; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TPrdPacketRawDetailRepository.Delete(AModel: TPrdPacketRawDetail; ACascade: TCascadeOperations);
begin
