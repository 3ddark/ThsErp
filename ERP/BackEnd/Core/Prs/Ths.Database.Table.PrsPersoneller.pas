...
begin
  ...
  FDogumTarihi := TFieldDB.Create('dogum_tarihi', ftDate, 0, Self, 'Doğum Tarihi');
  ...
  FCocukSayisi := TFieldDB.Create('cocuk_sayisi', ftInteger, 0, Self, 'Çocuk Sayısı');
  FYakinAdi := TFieldDB.Create('yakin_adi', ftWideString, '', Self, 'Yakın Adı');
  FYakinTelefon := TFieldDB.Create('yakin_telefon', ftWideString, '', Self, 'Yakın Telefon');
  FAyakkabiNo := TFieldDB.Create('ayakkabi_no', ftInteger, 0, Self, 'Ayakkabı No');
  ...
  FMaas := TFieldDB.Create('maas', ftFMTBcd, 0, Self, 'Maaş');
  FIkramiyeSayisi := TFieldDB.Create('ikramiye_sayisi', ftInteger, 0, Self, 'İkramiye Sayısı');
  FIkramiyeTutari := TFieldDB.Create('ikramiye_tutar', ftFMTBcd, 0, Self, 'İkramiye Tutar');
