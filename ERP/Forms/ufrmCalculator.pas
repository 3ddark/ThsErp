...
type
  ...
  private
    ...
    FOwnerEdit: TEdit;
  published
    constructor Create(AOwner: TComponent; AOwnerEdit: TEdit = nil); reintroduce; overload;
  public
...
constructor TfrmCalculator.Create(AOwner: TComponent; AOwnerEdit: TEdit);
begin
