...
--
-- Name: stk_cins_ozellikleri_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ths_admin
--

ALTER SEQUENCE public.stk_cins_ozellikleri_id_seq OWNED BY public.stk_cins_ozellikleri.id;
...
--
-- Name: stk_cins_ozellikleri id; Type: DEFAULT; Schema: public; Owner: ths_admin
--

ALTER TABLE ONLY public.stk_cins_ozellikleri ALTER COLUMN id SET DEFAULT nextval('public.stk_cins_ozellikleri_id_seq'::regclass);
