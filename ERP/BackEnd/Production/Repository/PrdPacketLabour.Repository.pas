...
type
  ...
  public
    ...
    procedure Delete(AModel: TPrdPacketLabour; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TPrdPacketLabourRepository.Delete(AModel: TPrdPacketLabour; ACascade: TCascadeOperations);
begin
