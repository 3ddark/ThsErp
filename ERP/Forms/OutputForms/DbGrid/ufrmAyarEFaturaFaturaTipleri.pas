...
function TfrmAyarEFaturaFaturaTipleri.CreateInputForm(Sender: TObject; pFormMode: TInputFormMode): TForm;
begin
  Result := nil;
  if (pFormMode = ifmRewiev) then
    Result := TfrmAyarEFaturaFaturaTipi.Create(Self, Self, Table.Clone(), pFormMode)
  else if (pFormMode = ifmNewRecord) then
    Result := TfrmAyarEFaturaFaturaTipi.Create(Self, Self, TAyarEFaturaFaturaTipi.Create(Table.Database), pFormMode)
