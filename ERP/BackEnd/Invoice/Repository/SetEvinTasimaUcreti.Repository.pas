...
type
  ...
  public
    ...
    procedure Delete(AModel: TSetEvinTransportPrice; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TSetEvinTransportPriceRepository.Delete(AModel: TSetEvinTransportPrice; ACascade: TCascadeOperations);
begin
