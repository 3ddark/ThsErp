...
type
  TfrmAccFirmaTipi = class(TfrmBaseInputDB)
...
procedure TfrmAccFirmaTipi.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAccFirmaTipi.FormDestroy(Sender: TObject);
begin
...
procedure TfrmAccFirmaTipi.RefreshData();
begin
...
procedure TfrmAccFirmaTipi.btnAcceptClick(Sender: TObject);
begin
