...
type
  ...
  public
    ...
    procedure Delete(AModel: TAlsTeklif; ACascade: TCascadeOperations = []); override;
  end;
...
procedure TAlsTeklifRepository.Delete(AModel: TAlsTeklif; ACascade: TCascadeOperations);
begin
