...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        LStokKarti := TStkInventory.Create(Table.Database);
        LFrmStokKarti := TfrmStkInventory.Create(TEdit(Sender), Self, LStokKarti, fomNormal, True);
