...
type
  TfrmAccBolgeHedef = class(TfrmBaseInputDB)
    lblbolge_id: TLabel;
...
procedure TfrmAccBolgeHedef.btnAcceptClick(Sender: TObject);
begin
...
procedure TfrmAccBolgeHedef.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAccBolgeHedef.FormDestroy(Sender: TObject);
begin
  FreeAndNil(FBolge);
  FreeAndNil(FPara);
  inherited;
...
procedure TfrmAccBolgeHedef.FormShow(Sender: TObject);
begin
  inherited;
  {$IFDEF DUMMY_VALUE}
